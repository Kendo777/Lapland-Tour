...
$sql="SELECT firstname, lastname, email, phone, city, profileimage FROM members WHERE memberID=".$_GET['memberID'];
...
if($row=$result->fetch_assoc()){
    ...
    if($row['profileimage']=='')
    {
        echo '<img class="card-img-top" src="../images/avatar.png" alt="Card image">';
    }else
    {
        echo '<img class="card-img-top" src="../images/members/'.$row['profileimage'].'" alt="Card image">';
    }
    echo'
        <div class="card-body">
